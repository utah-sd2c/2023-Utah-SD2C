...
public class TimedWalkStepViewController: ORKActiveStepViewController {
    ...
    private func walkStep() -> TimedWalkStep {
        step as! TimedWalkStep
    }
    ...
    private func createResult(score: Int) {
        let walkResult = TimedWalkStepResult(identifier: (step!.identifier))
...
public class GetUpAndGo: UIView {
    var visionContentView: TimedWalkContentView?
    ...
    func setupVisionContentView() {
        if visionContentView == nil {
            visionContentView = TimedWalkContentView()
        }
